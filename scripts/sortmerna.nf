...
RNADB16=\$DB/silva-arc-16s-id95.fasta,\$DB/silva-arc-16s-id95.idx:\$DB/silva-bac-16s-id90.fasta,\$DB/silva-bac-16s-id90.idx
sortmerna --reads read_pairs.fq --ref \$RNADB16 --fastx --aligned \$BNAME.rrna -v -a ${params.cpus}
